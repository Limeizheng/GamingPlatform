...
//            }
    ...
    public void saveGoods(Spu spu) {
        ...
        if(count!=1){
            throw new CloudException(ExceptionEnum.GOODS_SAVE_ERROE);
        }
        //新增detail
    ...
    public SpuDetail queryDetailById(Long spuId) {
        ...
        if(detail==null){
            throw new CloudException(ExceptionEnum.GOODS_DETAIL_NOT_FOUND);
        }
        return  detail;
    }
    ...
    public void updateGoods(Spu spu) {
        if(spu.getId()==null){
            throw new CloudException(ExceptionEnum.GOODS_ID_CANNOT_BE_NULL);
        }
        Sku sku = new Sku();
        sku.setSpuId(spu.getId());
        ...
        if(count!=1){
            ...
            throw new CloudException(ExceptionEnum.GOODS_UPDATE_ERROE);
        }
    ...
    private void fillStock(List<Long> ids, List<Sku> skus) {
        ...
        if (CollectionUtils.isEmpty(stocks)) {
            throw new CloudException(ExceptionEnum.STOCK_NOT_FOUND);
        }
