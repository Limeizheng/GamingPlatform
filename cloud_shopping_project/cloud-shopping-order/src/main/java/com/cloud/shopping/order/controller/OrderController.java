...
import com.cloud.shopping.utils.PayHelper;
import com.cloud.shopping.utils.PayState;
...
public class OrderController {
    ...
    public ResponseEntity<Long> createOrder(@RequestBody @Valid Order order) {
        ...
        System.out.println("创建订单Order："+id);
    ...
    public ResponseEntity<Order> queryOrderById(@PathVariable("id") Long id) {
        ...
        System.out.println("根据订单编号查询订单："+order.getOrderId());
        if (order == null) {
