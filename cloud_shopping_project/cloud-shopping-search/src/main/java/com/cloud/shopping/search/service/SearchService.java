package com.cloud.shopping.search.service;
...
import com.cloud.shopping.item.pojo.*;
import com.cloud.shopping.search.client.BrandClient;
import com.cloud.shopping.search.client.CategoryClient;
import com.cloud.shopping.search.client.GoodsClient;
import com.cloud.shopping.search.client.SpecificationClient;
import com.cloud.shopping.search.pojo.Goods;
import com.cloud.shopping.search.pojo.SearchRequest;
import com.cloud.shopping.search.pojo.SearchResult;
import com.cloud.shopping.search.repository.GoodsRepository;
...
public class SearchService {
    ...
    public Goods buildGoods(Spu spu){
        ...
        if(CollectionUtils.isEmpty(params)){
            throw new CloudException(ExceptionEnum.SPEC_PARAM_NOT_FOUND);
        }
        //查询商品详情
